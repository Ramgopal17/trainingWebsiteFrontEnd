...
import { BackEndApi } from "../data/auth_token";
import { sendMoreInfoData } from "@/api/send-more-info-data";
import Swal from "sweetalert2";

const CallToActionForm = ({ style_sv_details }) => {
  const sendDataToBackEnd = async (e) => {
    // console.log("Sending", e.target.Email.value);
    e.preventDefault();
    if (isFormValid(e)) {
      const result = await sendMoreInfoData(e);
    ...
    <>
      <style jsx>
        {`
          ...
          .input-item-textarea textarea {
            border-radius: 8px;
             {
              /* box-shadow: rgb(192 135 0) 0px 2px 8px 0px */
            }
             {
              /* box-shadow: #cfcfcf 0px 2px 8px 0px; */
            }
      ...
      <div className="col-xl-10 col-lg-8 formContainer ">
        ...
        <form
          ...
          // action={`${BackEndApi}/api/more-info-forms`}
          onSubmit={sendDataToBackEnd}
        >
          <div className="row it-cta-form mt-0">
            ...
            <div className="col-12">
              ...
              <button
                ...
                // style={{boxShadow: 'rgb(192 135 0) 0px 2px 8px 0px'}}
              >
                Submit Request
              </button>
            </div>
